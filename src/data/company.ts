...
export const companyInfo: CompanyInfo = {
  name: "Big 8 Intergrated",
  legalName: "Big 8 Intergrated LLC",
  city: "Houston",
  state: "Texas",
  country: "USA",
  description:
    "Industrial equipment, oilfield services, and technology solutions, headquartered in Houston, Texas.",
  tagline: "Better Solution for a Better World",
  story:
    "For more than 25 years, Big 8 Intergrated LLC has grown from its headquarters in Houston, Texas into a trusted procurement and equipment partner serving clients around the world. What began as a focused industrial supply operation has expanded into eight distinct divisions, without losing the personal, detail-driven service our clients have relied on since day one.",
  mission:
  ...
  contact: {
    ...
    email: "enquiries@big8intergrated.com",
